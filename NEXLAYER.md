...
**Live:** [https://relaxed-weasel-leanote.cloud.nexlayer.ai](https://relaxed-weasel-leanote.cloud.nexlayer.ai)  
...
**leanote** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/nickg/leanote:latest
    path: /
    servicePorts:
    - 9000
    vars:
      MONGO_URL: "mongodb://mongo.pod:27017/leanote"
  - name: mongo
